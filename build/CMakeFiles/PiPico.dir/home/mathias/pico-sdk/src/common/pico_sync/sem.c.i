# 0 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c"
...
# 8 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c" 2
...
int __attribute__((section(".time_critical." "sem_available"))) sem_available(semaphore_t *sem) {
    return *(volatile typeof(sem->permits) *) &sem->permits;
}

void __attribute__((section(".time_critical." "sem_acquire_blocking"))) sem_acquire_blocking(semaphore_t *sem) {
    do {
        ...
        spin_unlock((&sem->core)->spin_lock, save), __wfe();
    } while (
# 30 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c" 3 4
            1
# 30 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c"
                );
}


# 33 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c" 3 4
_Bool 
# 33 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c"
    __attribute__((section(".time_critical." "sem_acquire_timeout_ms"))) sem_acquire_timeout_ms(semaphore_t *sem, uint32_t timeout_ms) {
    return sem_acquire_block_until(sem, make_timeout_time_ms(timeout_ms));
}


# 37 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c" 3 4
_Bool 
# 37 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c"
    __attribute__((section(".time_critical." "sem_acquire_timeout_us"))) sem_acquire_timeout_us(semaphore_t *sem, uint32_t timeout_us) {
    return sem_acquire_block_until(sem, make_timeout_time_us(timeout_us));
}


# 41 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c" 3 4
_Bool 
# 41 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c"
    __attribute__((section(".time_critical." "sem_acquire_block_until"))) sem_acquire_block_until(semaphore_t *sem, absolute_time_t until) {
    do {
        uint32_t save = spin_lock_blocking(sem->core.spin_lock);
        if (sem->permits > 0) {
            sem->permits--;
            spin_unlock(sem->core.spin_lock, save);
            return 
# 47 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c" 3 4
                  1
# 47 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c"
                      ;
        }
        if (({ spin_unlock((&sem->core)->spin_lock, save); best_effort_wfe_or_timeout(until); })) {
            return 
# 50 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c" 3 4
                  0
# 50 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c"
                       ;
        }
    } while (
# 52 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c" 3 4
            1
# 52 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c"
                );
}


# 55 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c" 3 4
_Bool 
# 55 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c"
    __attribute__((section(".time_critical." "sem_try_acquire"))) sem_try_acquire(semaphore_t *sem) {
    uint32_t save = spin_lock_blocking(sem->core.spin_lock);
    if (sem->permits > 0) {
        sem->permits--;
        spin_unlock(sem->core.spin_lock, save);
        return 
# 60 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c" 3 4
              1
# 60 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c"
                  ;
    }
    spin_unlock(sem->core.spin_lock, save);
    return 
# 63 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c" 3 4
          0
# 63 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c"
               ;
}



# 67 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c" 3 4
_Bool 
# 67 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c"
    __attribute__((section(".time_critical." "sem_release"))) sem_release(semaphore_t *sem) {
    uint32_t save = spin_lock_blocking(sem->core.spin_lock);
    int32_t count = sem->permits;
    if (count < sem->max_permits) {
        sem->permits = (int16_t)(count + 1);
        spin_unlock((&sem->core)->spin_lock, save), __sev();
        return 
# 73 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c" 3 4
              1
# 73 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c"
                  ;
    } else {
        spin_unlock(sem->core.spin_lock, save);
        return 
# 76 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c" 3 4
              0
# 76 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c"
                   ;
    }
}

void __attribute__((section(".time_critical." "sem_reset"))) sem_reset(semaphore_t *sem, int16_t permits) {
    
# 81 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c" 3
   ((void)0)
# 81 "/home/mathias/pico-sdk/src/common/pico_sync/sem.c"
                                                      ;
    uint32_t save = spin_lock_blocking(sem->core.spin_lock);
