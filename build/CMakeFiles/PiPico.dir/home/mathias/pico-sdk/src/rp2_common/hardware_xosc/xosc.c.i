# 0 "/home/mathias/pico-sdk/src/rp2_common/hardware_xosc/xosc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/mathias/pico-sdk/src/rp2_common/hardware_xosc/xosc.c"
...
# 8 "/home/mathias/pico-sdk/src/rp2_common/hardware_xosc/xosc.c" 2
...
# 11 "/home/mathias/pico-sdk/src/rp2_common/hardware_xosc/xosc.c" 2


# 1 "/home/mathias/pico-sdk/src/rp2040/hardware_regs/include/hardware/regs/xosc.h" 1
# 14 "/home/mathias/pico-sdk/src/rp2_common/hardware_xosc/xosc.c" 2
...
# 15 "/home/mathias/pico-sdk/src/rp2_common/hardware_xosc/xosc.c" 2
# 27 "/home/mathias/pico-sdk/src/rp2_common/hardware_xosc/xosc.c"
void xosc_init(void) {

    ((xosc_hw_t *)0x40024000u)->ctrl = 0xaa0u;


    ((xosc_hw_t *)0x40024000u)->startup = (((((12u * 1000000) / 1000) + 128) / 256) * 1);


    hw_set_bits(&((xosc_hw_t *)0x40024000u)->ctrl, 0xfabu << 12u);


    while(!(((xosc_hw_t *)0x40024000u)->status & 0x80000000u));
}

void xosc_disable(void) {
    uint32_t tmp = ((xosc_hw_t *)0x40024000u)->ctrl;
    tmp &= (~0x00fff000u);
    tmp |= (0xd1eu << 12u);
    ((xosc_hw_t *)0x40024000u)->ctrl = tmp;
...
void xosc_dormant(void) {
    ...
    ((xosc_hw_t *)0x40024000u)->dormant = 0x636f6d61u;
