# 0 "/home/mathias/pico-sdk/src/rp2_common/pico_stdio_usb/stdio_usb_descriptors.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/mathias/pico-sdk/src/rp2_common/pico_stdio_usb/stdio_usb_descriptors.c"
# 31 "/home/mathias/pico-sdk/src/rp2_common/pico_stdio_usb/stdio_usb_descriptors.c"
...
# 129 "/home/mathias/pico-sdk/lib/tinyusb/src/tusb.h"
    tusb_inited(void);
# 32 "/home/mathias/pico-sdk/src/rp2_common/pico_stdio_usb/stdio_usb_descriptors.c" 2
...
# 33 "/home/mathias/pico-sdk/src/rp2_common/pico_stdio_usb/stdio_usb_descriptors.c" 2
# 1 "/home/mathias/pico-sdk/src/rp2_common/pico_unique_id/include/pico/unique_id.h" 1
# 46 "/home/mathias/pico-sdk/src/rp2_common/pico_unique_id/include/pico/unique_id.h"
typedef struct {
 uint8_t id[8];
} pico_unique_board_id_t;
# 60 "/home/mathias/pico-sdk/src/rp2_common/pico_unique_id/include/pico/unique_id.h"
void pico_get_unique_board_id(pico_unique_board_id_t *id_out);
# 74 "/home/mathias/pico-sdk/src/rp2_common/pico_unique_id/include/pico/unique_id.h"
void pico_get_unique_board_id_string(char *id_out, uint len);
# 34 "/home/mathias/pico-sdk/src/rp2_common/pico_stdio_usb/stdio_usb_descriptors.c" 2
# 88 "/home/mathias/pico-sdk/src/rp2_common/pico_stdio_usb/stdio_usb_descriptors.c"
...
static const uint8_t usbd_desc_cfg[((9) + (8+9+5+5+4+5+7+9+7+7) + 9)] = {
    9, TUSB_DESC_CONFIGURATION, ((uint8_t) ((((9) + (8+9+5+5+4+5+7+9+7+7) + 9)) & 0x00ff)), ((uint8_t) (((((9) + (8+9+5+5+4+5+7+9+7+7) + 9)) >> 8) & 0x00ff)), (3), 1, (0x00), (1UL << (7)) | (0), ((250))/2
                                                                   ,

    8, TUSB_DESC_INTERFACE_ASSOCIATION, (0), 2, TUSB_CLASS_CDC, CDC_COMM_SUBCLASS_ABSTRACT_CONTROL_MODEL, CDC_COMM_PROTOCOL_NONE, 0, 9, TUSB_DESC_INTERFACE, (0), 0, 1, TUSB_CLASS_CDC, CDC_COMM_SUBCLASS_ABSTRACT_CONTROL_MODEL, CDC_COMM_PROTOCOL_NONE, (0x04), 5, TUSB_DESC_CS_INTERFACE, CDC_FUNC_DESC_HEADER, ((uint8_t) ((0x0120) & 0x00ff)), ((uint8_t) (((0x0120) >> 8) & 0x00ff)), 5, TUSB_DESC_CS_INTERFACE, CDC_FUNC_DESC_CALL_MANAGEMENT, 0, (uint8_t)(((0)) + 1), 4, TUSB_DESC_CS_INTERFACE, CDC_FUNC_DESC_ABSTRACT_CONTROL_MANAGEMENT, 2, 5, TUSB_DESC_CS_INTERFACE, CDC_FUNC_DESC_UNION, (0), (uint8_t)(((0)) + 1), 7, TUSB_DESC_ENDPOINT, (0x81), TUSB_XFER_INTERRUPT, ((uint8_t) (((8)) & 0x00ff)), ((uint8_t) ((((8)) >> 8) & 0x00ff)), 16, 9, TUSB_DESC_INTERFACE, (uint8_t)(((0))+1), 0, 2, TUSB_CLASS_CDC_DATA, 0, 0, 0, 7, TUSB_DESC_ENDPOINT, (0x02), TUSB_XFER_BULK, ((uint8_t) (((64)) & 0x00ff)), ((uint8_t) ((((64)) >> 8) & 0x00ff)), 0, 7, TUSB_DESC_ENDPOINT, (0x82), TUSB_XFER_BULK, ((uint8_t) (((64)) & 0x00ff)), ((uint8_t) ((((64)) >> 8) & 0x00ff)), 0
                                                                                         ,


    9, TUSB_DESC_INTERFACE, (2), 0, 0, TUSB_CLASS_VENDOR_SPECIFIC, 0x00, 0x01, (0x05),
...
# 137 "/home/mathias/pico-sdk/src/rp2_common/pico_stdio_usb/stdio_usb_descriptors.c" 3
                                              __attribute__((__unused__)) 
# 137 "/home/mathias/pico-sdk/src/rp2_common/pico_stdio_usb/stdio_usb_descriptors.c"
                                                       uint8_t index) {
    return usbd_desc_cfg;
}

const uint16_t *tud_descriptor_string_cb(uint8_t index, 
# 141 "/home/mathias/pico-sdk/src/rp2_common/pico_stdio_usb/stdio_usb_descriptors.c" 3
                                                       __attribute__((__unused__)) 
# 141 "/home/mathias/pico-sdk/src/rp2_common/pico_stdio_usb/stdio_usb_descriptors.c"
                                                                uint16_t langid) {
    ...
    if (index == 0) {
        ...
        if (index >= sizeof(usbd_desc_str) / sizeof(usbd_desc_str[0])) {
            return 
# 156 "/home/mathias/pico-sdk/src/rp2_common/pico_stdio_usb/stdio_usb_descriptors.c" 3 4
                  ((void *)0)
# 156 "/home/mathias/pico-sdk/src/rp2_common/pico_stdio_usb/stdio_usb_descriptors.c"
                      ;
        }
