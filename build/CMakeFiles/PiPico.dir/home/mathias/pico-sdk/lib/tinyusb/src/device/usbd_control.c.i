# 0 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
# 27 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
...
# 28 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 2
...
# 32 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 2
...
# 129 "/home/mathias/pico-sdk/lib/tinyusb/src/tusb.h"
    tusb_inited(void);
# 33 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 2
...
# 114 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_pvt.h"
                                                              in_isr );
# 34 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 2
...
static uint8_t _usbd_ctrl_buf[64];
...
static inline 
# 66 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
             _Bool 
# 66 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
                  _status_stage_xact(uint8_t rhport, tusb_control_request_t const * request)
{

  uint8_t const ep_addr = request->bmRequestType_bit.direction ? EDPT_CTRL_OUT : EDPT_CTRL_IN;
  return usbd_edpt_xfer(rhport, ep_addr, 
# 70 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
                                        ((void *)0)
# 70 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
                                            , 0);
}



# 74 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
_Bool 
# 74 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
    tud_control_status(uint8_t rhport, tusb_control_request_t const * request)
{
  _ctrl_xfer.request = (*request);
  _ctrl_xfer.buffer = 
# 77 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
                            ((void *)0)
# 77 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
                                ;
...
static 
# 87 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
      _Bool 
# 87 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
           _data_stage_xact(uint8_t rhport)
{
  uint16_t const xact_len = tu_min16(_ctrl_xfer.data_len - _ctrl_xfer.total_xferred, 64);
  ...
  return usbd_edpt_xfer(rhport, ep_addr, xact_len ? _usbd_ctrl_buf : 
# 99 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
                                                                    ((void *)0)
# 99 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
                                                                        , xact_len);
}
...
# 104 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
_Bool 
# 104 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
    tud_control_xfer(uint8_t rhport, tusb_control_request_t const * request, void* buffer, uint16_t len)
{
  _ctrl_xfer.request = (*request);
  ...
  if (request->wLength > 0U)
  {
    ...
    {
      do { if ( !(buffer) ) { do {} while (0); do {} while (0); return 
# 115 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
     0
# 115 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
     ; } } while(0);
    }
    ...
    do { if ( !(_data_stage_xact(rhport)) ) { do {} while (0); do {} while (0); return 
# 121 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
   0
# 121 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
   ; } } while(0);
  }
  else
  {

    do { if ( !(_status_stage_xact(rhport, request)) ) { do {} while (0); do {} while (0); return 
# 126 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
   0
# 126 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
   ; } } while(0);
  }

  return 
# 129 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
        1
# 129 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
            ;
}
...
# 139 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
_Bool 
# 139 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
    usbd_control_xfer_cb (uint8_t rhport, uint8_t ep_addr, xfer_result_t event, uint32_t xferred_bytes);

void usbd_control_reset(void)
{
  memset((&_ctrl_xfer), 0, (sizeof(*(&_ctrl_xfer))));
}
...
void usbd_control_set_request(tusb_control_request_t const *request)
{
  _ctrl_xfer.request = (*request);
  _ctrl_xfer.buffer = 
# 156 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
                            ((void *)0)
# 156 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
                                ;
  _ctrl_xfer.total_xferred = 0;
  _ctrl_xfer.data_len = 0;
}
...
# 164 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
_Bool 
# 164 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
    usbd_control_xfer_cb (uint8_t rhport, uint8_t ep_addr, xfer_result_t result, uint32_t xferred_bytes)
{
  (void) result;
  ...
  {
    do { if ( !(0 == xferred_bytes) ) { do {} while (0); do {} while (0); return 
# 171 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
   0
# 171 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
   ; } } while(0);
    ...
    return 
# 182 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
          1
# 182 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
              ;
  }

  if ( _ctrl_xfer.request.bmRequestType_bit.direction == TUSB_DIR_OUT )
  {
    do { if ( !(_ctrl_xfer.buffer) ) { ; return 
# 187 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
   0
# 187 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
   ; } } while(0);
  ...
  if ( (_ctrl_xfer.request.wLength == _ctrl_xfer.total_xferred) || (xferred_bytes < 64) )
  {

    
# 200 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
   _Bool 
# 200 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
        is_ok = 
# 200 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
                1
# 200 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
    ...
    if ( is_ok )
    {
      ...
      do { if ( !(_status_stage_xact(rhport, &_ctrl_xfer.request)) ) { do {} while (0); do {} while (0); return 
# 216 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
     0
# 216 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
     ; } } while(0);
    }else
    {
  ...
  else
  {
    ...
    do { if ( !(_data_stage_xact(rhport)) ) { do {} while (0); do {} while (0); return 
# 227 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
   0
# 227 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
   ; } } while(0);
  }

  return 
# 230 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c" 3 4
        1
# 230 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_control.c"
            ;
}
