# 0 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
# 27 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
...
# 28 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 2



# 1 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd.h" 1
# 30 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd.h"
...
# 31 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd.h" 2
...
# 32 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 2
# 1 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_pvt.h" 1
# 29 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_pvt.h"
...
# 30 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_pvt.h" 2
...
# 114 "/home/mathias/pico-sdk/lib/tinyusb/src/device/usbd_pvt.h"
                                                              in_isr );
# 33 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 2
...
# 35 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 2
...
enum
{
  BULK_PACKET_SIZE = (((((0x0001)) & 0xff00) ? ((((0x0001)) & 0xff00) & 0x0400) : 0) ? 512 : 64)
};
...
typedef struct
{
  ...
  __attribute__ ((aligned(4))) uint8_t epout_buf[(((((0x0001)) & 0xff00) ? ((((0x0001)) & 0xff00) & 0x0400) : 0) ? 512 : 64)];
  __attribute__ ((aligned(4))) uint8_t epin_buf[(((((0x0001)) & 0xff00) ? ((((0x0001)) & 0xff00) & 0x0400) : 0) ? 512 : 64)];
 ...
 static cdcd_interface_t _cdcd_itf[(1)];

static 
# 81 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
      _Bool 
# 81 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
           _prep_out_transaction (cdcd_interface_t* p_cdc)
{
  ...
  do { if ( !(available >= sizeof(p_cdc->epout_buf)) ) { ; return 
# 90 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
 0
# 90 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
 ; } } while(0);


  do { if ( !(usbd_edpt_claim(rhport, p_cdc->ep_out)) ) { ; return 
# 93 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
 0
# 93 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
 ; } } while(0);
  ...
  }else
  {
    ...
    return 
# 106 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
          0
# 106 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
               ;
  }
}
...
# 113 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
_Bool 
# 113 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
    tud_cdc_n_connected(uint8_t itf)
{
...
# 151 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
_Bool 
# 151 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
    tud_cdc_n_peek(uint8_t itf, uint8_t* chr)
{
...
uint32_t tud_cdc_n_write(uint8_t itf, void const* buffer, uint32_t bufsize)
{
  ...
  if ( (tu_fifo_count(&p_cdc->tx_ff) >= BULK_PACKET_SIZE) || (((256) < BULK_PACKET_SIZE) && tu_fifo_full(&p_cdc->tx_ff)) )
  {
...
uint32_t tud_cdc_n_write_flush (uint8_t itf)
{
  ...
  do { if ( !(tud_ready()) ) { ; return 0; } } while(0);
  ...
  do { if ( !(usbd_edpt_claim(rhport, p_cdc->ep_in)) ) { ; return 0; } } while(0);
  ...
  if ( count )
  {
    do { if ( !(usbd_edpt_xfer(rhport, p_cdc->ep_in, p_cdc->epin_buf, count)) ) { do {} while (0); do {} while (0); return 0; } } while(0);
    return count;
  }else
  {
...
# 217 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
_Bool 
# 217 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
    tud_cdc_n_write_clear (uint8_t itf)
{
...
void cdcd_init(void)
{
  ...
  for(uint8_t i=0; i<(1); i++)
  {
    ...
    tu_fifo_config(&p_cdc->rx_ff, p_cdc->rx_ff_buf, ( sizeof(p_cdc->rx_ff_buf) / sizeof(p_cdc->rx_ff_buf[0]) ), 1, 
# 242 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
                                                                                       0
# 242 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
                                                                                            );




    tu_fifo_config(&p_cdc->tx_ff, p_cdc->tx_ff_buf, ( sizeof(p_cdc->tx_ff_buf) / sizeof(p_cdc->tx_ff_buf[0]) ), 1, 
# 247 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
                                                                                       1
# 247 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
                                                                                           );

    tu_fifo_config_mutex(&p_cdc->rx_ff, 
# 249 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
                                       ((void *)0)
# 249 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
                                           , osal_mutex_create(&p_cdc->rx_ff_mutex));
    tu_fifo_config_mutex(&p_cdc->tx_ff, osal_mutex_create(&p_cdc->tx_ff_mutex), 
# 250 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
                                                                               ((void *)0)
# 250 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
                                                                                   );
  }
}
...
void cdcd_reset(uint8_t rhport)
{
  ...
  for(uint8_t i=0; i<(1); i++)
  {
    ...
    memset((p_cdc), 0, (
# 262 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
   __builtin_offsetof (
# 262 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
   cdcd_interface_t
# 262 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
   , 
# 262 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
...
# 262 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
    ...
    tu_fifo_set_overwritable(&p_cdc->tx_ff, 
# 265 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
                                           1
# 265 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
                                               );
  }
}
...
uint16_t cdcd_open(uint8_t rhport, tusb_desc_interface_t const * itf_desc, uint16_t max_len)
{
  ...
  do { if ( !(TUSB_CLASS_CDC == itf_desc->bInterfaceClass && CDC_COMM_SUBCLASS_ABSTRACT_CONTROL_MODEL == itf_desc->bInterfaceSubClass) ) { ; return 0; } } while(0)
                                                                                         ;


  cdcd_interface_t * p_cdc = 
# 276 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
                            ((void *)0)
# 276 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
                                ;
  for(uint8_t cdc_id=0; cdc_id<(1); cdc_id++)
  {
  ...
  do { if ( !(p_cdc) ) { do {} while (0); do {} while (0); return 0; } } while(0);
  ...
  if ( TUSB_DESC_ENDPOINT == tu_desc_type(p_desc) )
  {
    ...
    do { if ( !(usbd_edpt_open(rhport, desc_ep)) ) { do {} while (0); do {} while (0); return 0; } } while(0);
       ...
       (TUSB_CLASS_CDC_DATA == ((tusb_desc_interface_t const *) p_desc)->bInterfaceClass) )
  {
    ...
    do { if ( !(usbd_open_edpt_pair(rhport, p_desc, 2, TUSB_XFER_BULK, &p_cdc->ep_out, &p_cdc->ep_in)) ) { do {} while (0); do {} while (0); return 0; } } while(0);
...
# 335 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
_Bool 
# 335 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
    cdcd_control_xfer_cb(uint8_t rhport, uint8_t stage, tusb_control_request_t const * request)
{

  do { if ( !(request->bmRequestType_bit.type == TUSB_REQ_TYPE_CLASS) ) { ; return 
# 338 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
 0
# 338 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
 ; } } while(0);
  ...
  for ( ; ; itf++, p_cdc++)
  {
    if (itf >= ( sizeof(_cdcd_itf) / sizeof(_cdcd_itf[0]) )) return 
# 346 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
                                               0
# 346 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
                                                    ;
...
# 385 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
       _Bool 
# 385 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
            const dtr = tu_bit_test(request->wValue, 0);
        
# 386 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
       _Bool 
# 386 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
            const rts = tu_bit_test(request->wValue, 1);
    ...
    default: return 
# 411 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
                   0
# 411 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
                        ;
  }

  return 
# 414 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
        1
# 414 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
            ;
}


# 417 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
_Bool 
# 417 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
    cdcd_xfer_cb(uint8_t rhport, uint8_t ep_addr, xfer_result_t result, uint32_t xferred_bytes)
{
  (void) result;
  ...
  do { if ( !(itf < (1)) ) { do {} while (0); do {} while (0); return 
# 430 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
 0
# 430 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
 ; } } while(0);
  ...
  if ( ep_addr == p_cdc->ep_in )
  {
    ...
    if ( 0 == tud_cdc_n_write_flush(itf) )
    {
      ...
      if ( !tu_fifo_count(&p_cdc->tx_ff) && xferred_bytes && (0 == (xferred_bytes & (BULK_PACKET_SIZE-1))) )
      {
        ...
        {
          usbd_edpt_xfer(rhport, p_cdc->ep_in, 
# 472 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
                                              ((void *)0)
# 472 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
                                                  , 0);
        }
      }
    }
  ...
  return 
# 480 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c" 3 4
        1
# 480 "/home/mathias/pico-sdk/lib/tinyusb/src/class/cdc/cdc_device.c"
            ;
}
